...
export function UserBasicInfo({ user }: UserBasicInfoProps) {
  ...
  return (
    <div className="space-y-6">
      {/* User Header */}
      <div className="flex items-start gap-4 p-4 bg-muted/30 rounded-2xl border-border shadow-md">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <Badge variant="outline" className="rounded-xl">{getRoleName()}</Badge>
          </div>
        </div>
      </div>

      {/* Basic Information */}
      <div className="space-y-4 p-4 bg-muted/30 rounded-2xl border-border shadow-sm">
      ...
      {getUserProp("roleSpecificInfo") && (
        <>
          ...
          <div className="p-4 bg-muted/30 rounded-2xl border-border shadow-sm">
            <h4 className="font-medium text-lg text-foreground">
              Thông tin vai trò
            </h4>
            <p className="text-sm text-muted-foreground p-3 bg-muted/30 rounded-xl border-border">
              {getUserProp("roleSpecificInfo")}
            </p>
          </div>
        </>
