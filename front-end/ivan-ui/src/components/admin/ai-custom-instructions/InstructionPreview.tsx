...
Bạn có câu hỏi cụ thể nào tôi có thể hỗ trợ không?`;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-blue-950 rounded-lg max-w-4xl w-full h-[95vh] flex flex-col border border-blue-200 dark:border-blue-800 shadow-2xl">
        {/* Fixed Header */}
        <div className="flex items-center justify-between p-6 border-b border-blue-200 dark:border-blue-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-t-lg flex-shrink-0">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-800 dark:to-indigo-800 rounded-lg flex items-center justify-center shadow-md">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            <Card className="bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-blue-950 border-blue-200 dark:border-blue-800 shadow-lg">
              ...
              <CardContent>
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg p-4 max-h-[300px] overflow-y-auto border border-blue-200 dark:border-blue-800">
            ...
            {behaviorInstructions && (
              <Card className="bg-gradient-to-br from-white to-indigo-50 dark:from-gray-900 dark:to-indigo-950 border-indigo-200 dark:border-indigo-800 shadow-lg">
                ...
                <CardContent>
                  <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950 dark:to-purple-950 rounded-lg p-4 max-h-[200px] overflow-y-auto border border-indigo-200 dark:border-indigo-800">
