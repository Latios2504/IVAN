  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-6 bg-gradient-to-br from-blue-50/80 via-indigo-50/80 to-purple-50/80 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-purple-950/30 rounded-xl border border-blue-200/50 dark:border-blue-800/50 shadow-lg">
        <div>
          <h2 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">Phân tích Đối tác</h2>
          <p className="bg-gradient-to-r from-blue-700 to-purple-700 dark:from-blue-300 dark:to-purple-300 bg-clip-text text-transparent font-medium">
            Theo dõi hiệu suất đối tác và hợp tác
          </p>
        </div>
      ...
      <Tabs defaultValue="collaborations" className="space-y-4">
        <TabsList className="bg-gradient-to-r from-gray-100/80 to-blue-100/80 dark:from-gray-800/80 dark:to-blue-800/80 border border-gray-200/50 dark:border-gray-700/50">
          <TabsTrigger value="collaborations" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white hover:bg-gradient-to-r hover:from-blue-50/80 hover:to-indigo-50/80 dark:hover:from-blue-900/50 dark:hover:to-indigo-900/50 transition-all duration-200">Phân tích Hợp tác</TabsTrigger>
          <TabsTrigger value="performance" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white hover:bg-gradient-to-r hover:from-blue-50/80 hover:to-indigo-50/80 dark:hover:from-blue-900/50 dark:hover:to-indigo-900/50 transition-all duration-200">Chỉ số Hiệu suất</TabsTrigger>
          <TabsTrigger value="industry" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white hover:bg-gradient-to-r hover:from-blue-50/80 hover:to-indigo-50/80 dark:hover:from-blue-900/50 dark:hover:to-indigo-900/50 transition-all duration-200">So sánh Ngành</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="collaborations" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-gradient-to-br from-green-50/80 via-emerald-50/80 to-teal-50/80 dark:from-green-950/30 dark:via-emerald-950/30 dark:to-teal-950/30 border border-green-200/50 dark:border-green-800/50 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <CardTitle className="bg-gradient-to-r from-green-600 to-teal-600 dark:from-green-400 dark:to-teal-400 bg-clip-text text-transparent">Hợp tác theo Loại</CardTitle>
            ...
            <Card className="bg-gradient-to-br from-yellow-50/80 via-orange-50/80 to-red-50/80 dark:from-yellow-950/30 dark:via-orange-950/30 dark:to-red-950/30 border border-yellow-200/50 dark:border-yellow-800/50 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <CardTitle className="bg-gradient-to-r from-yellow-600 to-red-600 dark:from-yellow-400 dark:to-red-400 bg-clip-text text-transparent">Đầu tư theo Loại</CardTitle>
                <p className="text-sm bg-gradient-to-r from-yellow-700 to-red-700 dark:from-yellow-300 dark:to-red-300 bg-clip-text text-transparent font-medium">
                  Cam kết tài chính theo loại đối tác
                </p>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={dashboardData?.collaborationsByType || []}>
                    ...
                    <Bar dataKey="amount" fill="#8884d8" name="Số tiền Đầu tư" />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
        ...
        <TabsContent value="performance" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-gradient-to-br from-purple-50/80 via-pink-50/80 to-rose-50/80 dark:from-purple-950/30 dark:via-pink-950/30 dark:to-rose-950/30 border border-purple-200/50 dark:border-purple-800/50 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <CardTitle className="bg-gradient-to-r from-purple-600 to-rose-600 dark:from-purple-400 dark:to-rose-400 bg-clip-text text-transparent">Đánh giá Đối tác</CardTitle>
                <p className="text-sm bg-gradient-to-r from-purple-700 to-rose-700 dark:from-purple-300 dark:to-rose-300 bg-clip-text text-transparent font-medium">
                  Đánh giá trung bình từ các tổ chức đối tác
                </p>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-gradient-to-br from-cyan-50/80 via-blue-50/80 to-indigo-50/80 dark:from-cyan-950/30 dark:via-blue-950/30 dark:to-indigo-950/30 border border-cyan-200/50 dark:border-cyan-800/50 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <CardTitle className="bg-gradient-to-r from-cyan-600 to-indigo-600 dark:from-cyan-400 dark:to-indigo-400 bg-clip-text text-transparent">Tóm tắt Đối tác</CardTitle>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium bg-gradient-to-r from-gray-700 to-blue-700 dark:from-gray-300 dark:to-blue-300 bg-clip-text text-transparent">Tỷ lệ Thành công</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium bg-gradient-to-r from-gray-700 to-blue-700 dark:from-gray-300 dark:to-blue-300 bg-clip-text text-transparent">Đầu tư Trung bình</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium bg-gradient-to-r from-gray-700 to-blue-700 dark:from-gray-300 dark:to-blue-300 bg-clip-text text-transparent">Sự kiện mỗi Đối tác</span>
        ...
        <TabsContent value="industry" className="space-y-4">
          <div className="grid grid-cols-1 gap-6">
            ...
            <Card className="bg-gradient-to-br from-slate-50/80 via-gray-50/80 to-zinc-50/80 dark:from-slate-950/30 dark:via-gray-950/30 dark:to-zinc-950/30 border border-slate-200/50 dark:border-slate-800/50 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <CardTitle className="bg-gradient-to-r from-slate-600 to-zinc-600 dark:from-slate-400 dark:to-zinc-400 bg-clip-text text-transparent">So sánh Ngành</CardTitle>
                <p className="text-sm bg-gradient-to-r from-slate-700 to-zinc-700 dark:from-slate-300 dark:to-zinc-300 bg-clip-text text-transparent font-medium">
                  So sánh đối tác của bạn qua các ngành khác nhau
                </p>
              </CardHeader>
              <CardContent>
                {dashboardData?.industryComparison && dashboardData.industryComparison.length > 0 ? (
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={dashboardData.industryComparison}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Bar dataKey="partnerCount" fill="#8884d8" name="Đối tác" />
                      <Bar dataKey="collaborationCount" fill="#82ca9d" name="Hợp tác" />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
                  <div className="text-center py-12 bg-gradient-to-br from-gray-50/50 to-slate-50/50 dark:from-gray-900/30 dark:to-slate-900/30 rounded-xl border border-gray-200/30 dark:border-gray-700/30">
                    ...
                    <p className="bg-gradient-to-r from-gray-600 to-slate-600 dark:from-gray-400 dark:to-slate-400 bg-clip-text text-transparent">
                      Dữ liệu so sánh ngành sẽ có sẵn khi bạn xây dựng thêm đối tác
                    </p>
                  </div>
                )}
              </CardContent>
