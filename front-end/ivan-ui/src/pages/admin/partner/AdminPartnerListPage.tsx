...
import type { PartnerProfileData, PartnerIndustry } from "@/types/partner-profile";
...
const mockPartners: PartnerProfileData[] = [
  ...
  },
  {
    ...
    description: "Non-profit organization focused on education and community development initiatives.",
...
export default function AdminPartnerListPage() {
  ...
  const filteredPartners = partners.filter(partner => {
    ...
    return matchesSearch && matchesVerification && matchesIndustry && matchesActive;
  });
        ...
        {filteredPartners.length === 0 ? (
          <Card>
            <CardContent className="text-center py-8">
              ...
              <p className="text-gray-500">Không tìm thấy đối tác nào phù hợp với bộ lọc.</p>
            </CardContent>
          </Card>
        ) : (
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge className={partner.isVerified ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}>
                        {partner.isVerified ? (
                          <>
