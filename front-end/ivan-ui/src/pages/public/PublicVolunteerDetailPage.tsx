...
export const PublicVolunteerDetailPage = () => {
  ...
  if (error || !volunteer) {
    return (
      <PublicPageLayout
        ...
        description="The volunteer you're looking for could not be found."
      >
        <div className="container mx-auto px-4 py-8">
  ...
  return (
    <PublicPageLayout
      ...
      description={volunteer.motivation || volunteer.experience || `Learn more about ${volunteer.fullName}, a dedicated volunteer ready to make a difference.`}
    >
      <div className="container mx-auto px-4 py-8">
        {/* Breadcrumb */}
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/volunteers">Volunteers</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>{volunteer.fullName}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {volunteer.skillsList.map((skill) => (
                      <Badge key={skill.skillId} variant="secondary" className="text-sm">
                        {skill.skillName}
                      </Badge>
                    ))}
                  </div>
